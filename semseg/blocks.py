...
def Conv2d(in_channels, out_channels,kernel_size=1,padding=0,dilation=1):
    return nn.Sequential(*[
            nn.Conv2d(in_channels, out_channels,kernel_size,padding=padding,bias=False,dilation=dilation), #
...
class DenseBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.layer1 = Conv2d(in_channels, out_channels)
